...
import {
  ...
  shadcnAlertSvelte,
  shadcnDialogSvelte,
  HEADLESSUI_MENU_TEMPLATE,
  HEADLESSUI_DIALOG_TEMPLATE,
  HEADLESSUI_SWITCH_TEMPLATE
} from "../../templates/index.js";

export function handleGetSvelteComponentTemplate(args: { component_name: string }) {
